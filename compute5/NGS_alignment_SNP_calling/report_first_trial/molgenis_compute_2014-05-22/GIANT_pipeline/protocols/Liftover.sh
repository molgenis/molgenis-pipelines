...
cp ${GIANT_workDir_originalFiles}/${GIANT_chrX_original_tmp_name}.ped ${GIANT_workDir_studyDir}/chrX.ped
cp ${GIANT_workDir_originalFiles}/${GIANT_chrX_original_tmp_name}.map ${GIANT_workDir_studyDir}/chrX.map
