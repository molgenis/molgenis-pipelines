...
Description of the sample preparation and sequencing and different steps used in the RNA analysis pipeline

Gene expression quantification
The trimmed fastQ files where aligned to build ${genome} human reference genome using Bowtie
${bowtieVersion} [1]. Before gene quantification
