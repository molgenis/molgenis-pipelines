...
sh /apps/software/Molgenis-Compute/v15.04.1-Java-1.7.0_80/molgenis_compute.sh --backend slurm \
  ...
  -w /groups/umcg-wijmenga/tmp04/umcg-ndeklein/molgenis-pipelines/compute5/Public_RNA-seq_genotypeCalling/workflowGenotypeCalling.csv \
